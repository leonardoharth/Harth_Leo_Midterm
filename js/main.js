...
var slides = [
  ...
  { title: "Total Yearly Green House Gas emission per compliance status.", description: "The compliance status does not penalize either the largest emissions of green house gas. In this page, you can see that the buildings with the largest emission are compliant with the regulation. I hope you have enjoyed this slideshow." }
]
